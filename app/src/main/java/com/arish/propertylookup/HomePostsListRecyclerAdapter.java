...
public class HomePostsListRecyclerAdapter extends RecyclerView.Adapter<HomePostsListRecyclerAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public HomePostsListRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomePostsListRecyclerAdapter.MyViewHolder holder, final int position) {
        ...
        final String mainImage = postList.get(position).getImages().get(0);
        ...
        holder.userNameTextView.setText(("Posted by ").concat(userName));
        ...
        holder.whatsappImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Log.e("Error: ", "Error in opening messenger : " + e.toString());
        ...
        holder.postCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("fromFragment", "homeFragment");
    ...
    public HomePostsListRecyclerAdapter(ArrayList<PropertyPostModelClass> postList) {
